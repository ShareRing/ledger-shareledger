...
#ifdef APP_SECRET_MODE_ENABLED
UX_STEP_CB(ux_idle_flow_4_step, bn, h_secret_click(), { "Developed by:", "ShareRing", });
#else
UX_STEP_NOCB(ux_idle_flow_4_step, bn, { "Developed by:", "ShareRing", });
#endif
...
UX_STEP_NOCB(ux_menu_init_flow_4_step, bn, { "Developed by:", "ShareRing", });
